...
Карта поддерживает зуминг. Остановки должны показываться на фоне карты <a href="https://carto.com/">CARTO</a>.
...
Соблюдается следующая зависимость цвета от параметра cost : cost 5 — зеленый, 5-15 — желтый, 15-30 - красный, нельзя доехать - чёрный.
